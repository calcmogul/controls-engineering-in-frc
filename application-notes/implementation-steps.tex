...
the open-loop system, our control input $\mtx{u}$ was a vector of system inputs.
In the closed-loop system, our control input $\mtx{u}$ is now a vector of
reference states $\mtx{r}$. To use this form in simulation, the corresponding
