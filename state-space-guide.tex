...
\renewcommand*{\partpath}{modern-control-theory-notation}
\input{\partpath/linear-algebra}
\input{\partpath/intro-to-modern-control}

\part{Linear control theory}
\renewcommand*{\partpath}{linear-control-theory}
...
\renewcommand*{\partpath}{nonlinear-control-theory}
...
\input{\partpath/calculus-methods}
