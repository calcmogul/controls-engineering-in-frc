...
Figure \ref{fig:feedback_loop} is a block diagram with more formal notation in a
...
\noindent The closed-loop gain for figure \ref{fig:feedback_loop} is

\begin{equation}
  \frac{Y(s)}{X(s)} = \frac{P_1}{1 \mp P_1 P_2}
\end{equation}

\noindent See appendix \ref{ch:app-tf-feedback-deriv} for a derivation.
