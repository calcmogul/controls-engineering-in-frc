...
As $\omega$ increases in $s = j\omega$, a pole there moves around the perimeter
of the unit circle in the z-plane. Once it hits $\frac{\omega_s}{2}$ (half the
...
Table \ref{tab:disc_approx_scalar} compares the Taylor expansions of the
...
Table \ref{tab:disc_approx_matrix} compares the Taylor expansions of the
