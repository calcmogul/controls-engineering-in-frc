...
Table \ref{tab:disc-approx} compares the Taylor expansions of the discretization
methods presented so far. The bilinear transform does best with accuracy
trailing off after the third order term. Forward Euler has no second order or
higher terms, so it undershoots. Backward Euler has twice the second order term
and overshoots the remaining higher order terms as well.
...
\begin{booktable}
  \begin{tabular}{|cll|}
    ...
    \hline
    Matrix exponential (exact) &
      $\mtx{\Phi} = e^{\mtx{A}T}$ &
      $\mtx{\Phi} = 1 + \mtx{A}T + \frac{1}{2}\mtx{A}^2T^2 +
        \frac{1}{6}\mtx{A}^3T^3 + \ldots$ \\
    Bilinear transformation &
      $\mtx{\Phi} = \frac{1 + \frac{1}{2}\mtx{A}T}{1 - \frac{1}{2}\mtx{A}T}$ &
      $\mtx{\Phi} = 1 + \mtx{A}T + \frac{1}{2}\mtx{A}^2T^2 +
    ...
    Forward Euler &
      ...
      $\mtx{\Phi} = 1 + \mtx{A}T$ \\
    Reverse Euler &
      $\mtx{\Phi} = \frac{1}{1 - \mtx{A}T}$ &
      $\mtx{\Phi} = 1 + \mtx{A}T + \mtx{A}^2T^2 + \mtx{A}^3T^3 + \ldots$ \\
    \hline
  \end{tabular}
  \caption{Taylor series expansions of discretization methods}
  \label{tab:disc-approx}
\end{booktable}
