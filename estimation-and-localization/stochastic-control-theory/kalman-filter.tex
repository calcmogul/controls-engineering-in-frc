...
\mtx{C}_{k+1} \hat{\mtx{x}}_{k+1}^-)$, we want to find the value of $\mtx{K}$
...
\begin{align*}
  ...
  \mtx{P}_{k+1}^+ &= \cov(\mtx{x}_{k+1} - (\hat{\mtx{x}}_{k+1}^- +
    \mtx{K}_{k+1}(\mtx{y}_{k+1} - \mtx{C}_{k+1} \hat{\mtx{x}}_{k+1}^-))) \\
  \mtx{P}_{k+1}^+ &= \cov(\mtx{x}_{k+1} - (\hat{\mtx{x}}_{k+1}^- +
    \mtx{K}_{k+1}(\mtx{C}_{k+1}\mtx{x}_{k+1} + \mtx{v}_{k+1} -
    \mtx{C}_{k+1} \hat{\mtx{x}}_{k+1}^-))) \\
  \mtx{P}_{k+1}^+ &= \cov(\mtx{x}_{k+1} - (\hat{\mtx{x}}_{k+1}^- +
    \mtx{K}_{k+1}\mtx{C}_{k+1}\mtx{x}_{k+1} + \mtx{K}_{k+1}\mtx{v}_{k+1} -
    \mtx{K}_{k+1}\mtx{C}_{k+1} \hat{\mtx{x}}_{k+1}^-)) \\
  \mtx{P}_{k+1}^+ &= \cov(\mtx{x}_{k+1} - \hat{\mtx{x}}_{k+1}^- -
    \mtx{K}_{k+1}\mtx{C}_{k+1}\mtx{x}_{k+1} - \mtx{K}_{k+1}\mtx{v}_{k+1} +
    \mtx{K}_{k+1}\mtx{C}_{k+1} \hat{\mtx{x}}_{k+1}^-)
\end{align*}

Factor out $\mtx{K}_{k+1} \mtx{C}_{k+1}$.
...
Factor out $\mtx{I} - \mtx{K}_{k+1} \mtx{C}_{k+1}$.
...
\begin{align}
  ...
  \mtx{P}_{k+1}^+ =~&
    (\mtx{P}_{k+1}^- - \mtx{K}_{k+1}\mtx{C}_{k+1}\mtx{P}_{k+1}^-)
    (\mtx{I}^T - \mtx{C}_{k+1}^T\mtx{K}_{k+1}^T) +
    \mtx{K}_{k+1}\mtx{R}_{k+1} \mtx{K}_{k+1}^T \nonumber \\
  \mtx{P}_{k+1}^+ =~&
    \mtx{P}_{k+1}^-(\mtx{I}^T - \mtx{C}_{k+1}^T\mtx{K}_{k+1}^T) -
...
\begin{theorem}[Kalman filter]
  ...
  \begin{align}
    ...
    \hat{\mtx{x}}_{k+1}^+ &=
      \hat{\mtx{x}}_{k+1}^- + \mtx{K}_{k+1}(\mtx{y}_{k+1} -
      \mtx{C} \hat{\mtx{x}}_{k+1}^-) \label{eq:post1_x} \\
  ...
  \begin{figurekey}
    \begin{tabular}{llll}
      ...
      $\mtx{C}$ & measurement matrix      & $\mtx{y}$ & output vector \\
...
$\mtx{C}$, $\mtx{Q}$, and $\mtx{R}$ from the equations derived earlier are made
constants here.
