...
There's several selection heuristics for sigma points. Merwe scaled sigma
points\footfullcite{bib:ukf_merwe_scaled_sigma_points} are a popular choice,
but Scaled Spherical Simplex sigma points\footfullcite{bib:ukf_s3_sigma_points}
require fewer points for the same accuracy.
