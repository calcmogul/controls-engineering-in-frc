\chapterimage{banana-slug.jpg}{A sample from the Santa Cruz banana (slug)
  distribution \cite{bib:banana_distribution}}
...
This will be a math-heavy introduction, so read \textit{Kalman and Bayesian
Filters in Python} by Roger
Labbe\footnote{\url{https://github.com/rlabbe/Kalman-and-Bayesian-Filters-in-Python/}}
first.
...
\input{\chapterpath/extended-kalman-filter}
\input{\chapterpath/unscented-kalman-filter}
