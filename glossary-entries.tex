...
\newglossaryentry{gain margin}{
  name={gain margin},
  description={See section \ref{subsec:gain_phase_margin} on gain and phase
    margin.}}
...
\newglossaryentry{observer}{
  name={observer},
  description={In control theory, a \gls{system} that estimates the internal
    \gls{state} of a given real \gls{system} from measurements of the
    \gls{input} and \gls{output} of the real \gls{system}.}}
...
\newglossaryentry{pose}{
  name={pose},
  description={The position and orientation of an \gls{agent} in the world,
    which is represented by all or part of the \gls{agent}'s \gls{state}.}}
...
\newglossaryentry{system}{
  ...
  description={A term encompassing a \gls{plant} and its interaction with a
    \gls{controller} and \gls{observer}, which are treated as a single entity.
