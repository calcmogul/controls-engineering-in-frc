...
We won't be using root locus plots for any of our control systems analysis, but
it does help provide an intuition for what controllers actually do to a system.
