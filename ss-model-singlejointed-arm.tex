...
\begin{figure}[H]
  ...
  \begin{tikzpicture}[auto, >=latex', circuit ee IEC,
    ...
    \draw[fill=black!50] (4.09,2.42) rectangle (5.35,2.52);

    % Single-jointed arm
    \draw[fill=white] (5.05,2.54) -- (5.15,2.49) -- (5.4,3.99) -- (5.3,4.04)
      -- cycle;
    \draw[fill=black!50] (5.15,2.49) -- (5.35,2.49) -- (5.6,3.99) -- (5.4,3.99)
      -- cycle;
    \draw[fill=white] (5.3,4.04) -- (5.4,3.99) -- (5.6,3.99) -- (5.5,4.04)
      -- cycle;

    % Arm length arrow
    \draw[line width=0.7pt,<->] (5.6,2.49) -- node[right] {$l$} (5.85,3.99);
