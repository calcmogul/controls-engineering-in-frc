...
\subsubsection{Trapezoidal motion profile}
...
Snippet \ref{lst:trapezoidal_motion_profile} shows a Python implementation.
\begin{codesubset}{Python}{build/frccontrol/frccontrol/profiles.py}{4}{58}
  \caption{Trapezoidal motion profile implementation in Python}
...
Snippet \ref{lst:s-curve_motion_profile} shows a Python implementation.
\begin{codesubset}{Python}{build/frccontrol/frccontrol/profiles.py}{61}{141}
  \caption{S-curve motion profile implementation in Python}
  \label{lst:s-curve_motion_profile}
\end{codesubset}
