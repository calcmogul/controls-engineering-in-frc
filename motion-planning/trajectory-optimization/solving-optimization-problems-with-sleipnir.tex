...
Sleipnir's
examples\footnote{\url{https://github.com/SleipnirGroup/Sleipnir/tree/v0.3.4/examples}}
and
tests\footnote{\url{https://github.com/SleipnirGroup/Sleipnir/tree/v0.3.4/test}}\footnote{\url{https://github.com/SleipnirGroup/Sleipnir/tree/v0.3.4/python/test/optimization}}
