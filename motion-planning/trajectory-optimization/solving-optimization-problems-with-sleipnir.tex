...
Sleipnir's
examples\footnote{\url{https://github.com/SleipnirGroup/Sleipnir/tree/v0.3.5/examples}}
and
tests\footnote{\url{https://github.com/SleipnirGroup/Sleipnir/tree/v0.3.5/test}}\footnote{\url{https://github.com/SleipnirGroup/Sleipnir/tree/v0.3.5/python/test/optimization}}
