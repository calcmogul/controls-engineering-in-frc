...
Sleipnir's
examples\footnote{\url{https://github.com/SleipnirGroup/Sleipnir/tree/v0.6.2/examples}}
and
tests\footnote{\url{https://github.com/SleipnirGroup/Sleipnir/tree/v0.6.2/test}}\footnote{\url{https://github.com/SleipnirGroup/Sleipnir/tree/v0.6.2/python/test/optimization}}
