...
example of a double integrator. We want to go from $0$ m at rest to $2$ m at
...
\begin{coderemotesubset}{Python}{\chapterpath/double_integrator.py}{47}{55}
\end{coderemotesubset}

\subsubsection{Specifying a cost function}

Next, we'll create a cost function for minimizing position error.
\begin{coderemotesubset}{Python}{\chapterpath/double_integrator.py}{57}{58}
\end{coderemotesubset}
...
\begin{coderemotesubset}{Python}{\chapterpath/double_integrator.py}{60}{60}
\end{coderemotesubset}
...
Sleipnir's
examples\footnote{\url{https://github.com/SleipnirGroup/Sleipnir/tree/v0.6.3/examples}}
and
tests\footnote{\url{https://github.com/SleipnirGroup/Sleipnir/tree/v0.6.3/test}}\footnote{\url{https://github.com/SleipnirGroup/Sleipnir/tree/v0.6.3/python/test/optimization}}
demonstrate constrained AprilTag pose estimation, subsystem current allocation,
and various direct transcription, direct collocation, and single shooting
