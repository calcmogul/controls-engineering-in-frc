...
Sleipnir's
examples\footnote{\url{https://github.com/SleipnirGroup/Sleipnir/tree/v0.4.0/examples}}
and
tests\footnote{\url{https://github.com/SleipnirGroup/Sleipnir/tree/v0.4.0/test}}\footnote{\url{https://github.com/SleipnirGroup/Sleipnir/tree/v0.4.0/python/test/optimization}}
