...
\index{motion planning!1-DOF motion profile}
\index{motion profiles!1-DOF motion profile}
...
\begin{bookfigure}
  \begin{minisvg}{2}{build/\chapterpath/trapezoid_profile}
    \caption{Trapezoid profile}
    \label{fig:trapezoid_profile}
  \end{minisvg}
  \hfill
  \begin{minisvg}{2}{build/\chapterpath/s_curve_profile}
...
\index{motion planning!S-curve profile}
\index{motion profiles!S-curve profile}
...
\index{motion planning!trapezoid profile}
\index{motion profiles!trapezoid profile}
...
\begin{remark}
  S-curve profiles are unnecessary for FRC mechanisms. Motors in FRC effectively
