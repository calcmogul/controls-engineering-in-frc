\section{Integral gain}

The \textit{Integral} term accumulates the area between the \gls{setpoint}
and \gls{output} plots over time and adds the current total to the
\gls{control input}. Accumulating the area between two curves is called
integration.
