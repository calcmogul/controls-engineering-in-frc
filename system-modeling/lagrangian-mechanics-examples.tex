...
Mechanics} by Simon J.A.
Malham\footnote{\url{https://www.macs.hw.ac.uk/~simonm/mechanics.pdf}} for the
basics.

\renewcommand*{\chapterpath}{\partpath/lagrangian-mechanics-examples}
\input{\chapterpath/single-jointed-arm}
\input{\chapterpath/double-jointed-arm}
\input{\chapterpath/cart-pole}
