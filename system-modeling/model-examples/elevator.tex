...
We want to derive an equation for the carriage acceleration $a_m$ (derivative of
$v_m$) given an input voltage $V$, which we can integrate to get carriage
...
Substitute in equation \eqref{eq:elevator_torque_pulley} for $\tau_p$.
