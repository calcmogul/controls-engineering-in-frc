...
\begin{booktable}
  \begin{tabular}{|ccc|}
    ...
    \multicolumn{1}{|c}{\textbf{Leibniz notation}} &
      ...
      \multicolumn{1}{c|}{\textbf{Newton notation}} \\
    \hline
...
Lagrange notation is voiced as ``f prime of x", ``f double-prime of x", etc.
Newton notation is voiced as ``f dot of x", ``f double-dot of x", etc.
