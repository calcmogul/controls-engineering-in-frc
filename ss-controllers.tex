...
form (see subsubsection \ref{subsubsec:ctrl_canon}). This can be done with state
observers as well with observable canonical form (see subsubsection
\ref{subsubsec:obsv_canon}).
...
resulting controller is guaranteed to be stable and \glslink{robustness}{robust}
