...
% Copyright notice
Copyright \copyright\ 2017-\input{build/commit-year.txt}\unskip~Tyler Veness
...
Generated from \input{build/commit-hash.txt}\unskip~made on
\input{build/commit-date.txt}\unskip. The latest version can be downloaded from
