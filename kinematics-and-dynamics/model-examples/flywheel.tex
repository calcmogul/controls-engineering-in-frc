...
First, rearrange equation (\ref{eq:dot_omega_f}) into the form $y = mx + b$
...
\begin{align}
  \frac{J K_v R}{G^2 K_t} \dot{\omega}_f &= \frac{G K_t}{R} \cdot
    \frac{K_v R}{G^2 K_t} V - \omega_f \nonumber \\
  \frac{J K_v R}{G^2 K_t} \dot{\omega}_f &= \frac{K_v}{G} V - \omega_f \nonumber
    \\
  \omega_f &= \frac{K_v}{G} V - \frac{J K_v R}{G^2 K_t} \dot{\omega}_f
...
\begin{enumerate}
  ...
  \item Perform a linear regression of angular velocity versus angular
    ...
    as per equation (\ref{eq:flywheel_J_regression}).
