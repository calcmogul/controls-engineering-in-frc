...
Substitute in equation (\ref{eq:diff_drive_dotv_l}) to obtain an expression for
$\dot{v}_r$.
...
Substitute equation (\ref{eq:diff_drive_vr_2mid}) back into equation
(\ref{eq:diff_drive_dotv_l}) to obtain an expression for $\dot{v}_l$.
...
\begin{enumerate}
  ...
  \item Perform a linear regression of linear velocity versus angular velocity.
    ...
    (\ref{eq:diff_drive_J_regression}).
