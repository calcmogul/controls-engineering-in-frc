...
\begin{remark}
  If current limiting is desired, one can use the following pseudocode given
  accurate current and angular velocity measurements. We'll show how the latter
  measurement can be omitted when using a \gls{model} and \gls{observer} in
  subsection \ref{subsec:flywheel_model_without_encoder}.
