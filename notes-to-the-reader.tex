...
\begin{itemize}
  ...
  \item Part III, "Controls design/implementation," describes how to apply the
    ...
    are augmented with $u_error$ estimators to help handle model uncertainty.
  \item \textit{Appendices} provide useful information that isn't required for
    a passing understanding of the material. This includes derivations for many
    of the results presented and used in the main body of the book.
\end{itemize}
