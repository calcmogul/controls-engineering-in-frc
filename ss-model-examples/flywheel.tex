...
Notice how the control effort when the reference is reached is nonzero. This is
the two-state feedforward compensating for the system dynamics attempting to
slow the flywheel down when no voltage is applied.
