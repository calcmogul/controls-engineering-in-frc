...
\begin{svg}{build/code/frccontrol/examples/drivetrain_pzmaps}
  \caption{Drivetrain pole-zero maps.}
  \label{fig:drivetrain_pzmaps}
\end{svg}

\begin{svg}{build/code/frccontrol/examples/drivetrain_response}
...
The script linked above also generates two files: DrivetrainCoeffs.h and DrivetrainCoeffs.cpp.
