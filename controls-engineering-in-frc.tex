...
\usepackage[top=3cm,bottom=3cm,left=3cm,right=3cm,
            headsep=10pt,marginpar=70pt,a4paper]{geometry}
\usepackage{graphicx} % For including figures
\graphicspath{{figs/}} % Specifies directory where figures are stored
...
\input{\partpath/transfer-functions}
...
\input{\partpath/ss-applications}
...
\input{\partpath/robust-control}
\input{\partpath/installing-python-packages}
\input{\partpath/linear-quadratic-regulator}
\input{\partpath/qr-weighted-linear-plant-inversion}
\input{\partpath/steady-state-feedforward}
