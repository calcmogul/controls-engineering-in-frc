...
\footnote{\url{https://github.com/wpilibsuite/allwpilib/blob/main/wpilibjExamples/src/main/java/org/wpilib/examples/statespaceflywheel/Robot.java}}
...
$R = 0.0902 \,\Omega$, and $L = 230$ μH. Notice the millisecond-timescale
oscillation in figure \ref{fig:cs_ss_cim_second_order_step} compared to figure
\ref{fig:cs_ss_cim_first_order_step}. If more mass is added to the motor
