...
integration. Avoid it because it suffers from numerical stability issues. We'll
demonstrate how to translate its Butcher tableau into equations that integrate
...
Other methods of Runge-Kutta integration exist with various
properties,\footnote{\url{https://en.wikipedia.org/wiki/Runge\%E2\%80\%93Kutta_methods\#Explicit_Runge.E2.80.93Kutta_methods}}
but the one presented here is popular for its high accuracy relative to the
amount of floating point operations (FLOPs) it requires.
