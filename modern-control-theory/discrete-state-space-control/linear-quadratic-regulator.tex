...
\gls{phase margin} of 60 degrees.\footfullcite{bib:lqr_phase_margin} However,
using a state estimator forfeits the robustness
guarantees.\footfullcite{bib:lqg_guaranteed_margins}
\begin{remark}
